...
public class CWEModelActivator extends Plugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "dsm.cwe.model"; //$NON-NLS-1$

	// The shared instance
	private static CWEModelActivator plugin;
	 ...
	 */
	public static CWEModelActivator getDefault() {
		return plugin;
	}
	...
	public static void logInfo(String msg) {
		CWEModelActivator act = getDefault();
		if (act != null) {
