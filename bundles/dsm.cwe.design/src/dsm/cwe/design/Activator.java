...
public class Activator extends AbstractUIPlugin {
	// The plug-in ID
	public static final String PLUGIN_ID = "dsm.cwe.design";

	public static String CWE_VIEWPOINT_NAME = "CWEViewPoint";
	...
	public void start(BundleContext context) throws Exception {
		...
		viewpoints.addAll(ViewpointRegistry.getInstance().registerFromPlugin(PLUGIN_ID + "/description/cwe.odesign"));
