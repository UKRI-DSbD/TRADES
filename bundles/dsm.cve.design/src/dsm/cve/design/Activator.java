...
public class Activator extends AbstractUIPlugin {
	// The plug-in ID
	public static final String PLUGIN_ID = "dsm.cve.design";

	public static String CVE_VIEWPOINT_NAME = "CVEViewPoint";
	...
	public void start(BundleContext context) throws Exception {
		...
		viewpoints.addAll(ViewpointRegistry.getInstance().registerFromPlugin(PLUGIN_ID + "/description/cve.odesign"));
