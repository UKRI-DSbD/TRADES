 ...
 * </p>
 * <ul>
 *   <li>{@link dsm.oscal.model.CWECatalog.impl.WeaknessImpl#getID <em>ID</em>}</li>
 *   <li>{@link dsm.oscal.model.CWECatalog.impl.WeaknessImpl#getValue <em>Value</em>}</li>
 *   <li>{@link dsm.oscal.model.CWECatalog.impl.WeaknessImpl#getAbstraction <em>Abstraction</em>}</li>
 *   <li>{@link dsm.oscal.model.CWECatalog.impl.WeaknessImpl#getStructure <em>Structure</em>}</li>
 *   <li>{@link dsm.oscal.model.CWECatalog.impl.WeaknessImpl#getStatus <em>Status</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WeaknessImpl extends MinimalEObjectImpl.Container implements Weakness {
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CWECatalogPackage.WEAKNESS__VALUE, oldValue, value));
	}
