 ...
 * </p>
 * <ul>
 *   <li>{@link dsm.cve.model.CVECatalog.impl.ExternalReferenceImpl#getReferenceID <em>Reference ID</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExternalReferenceImpl extends MinimalEObjectImpl.Container implements ExternalReference {
	...
	protected EClass eStaticClass() {
		return CVECatalogPackage.Literals.EXTERNAL_REFERENCE;
	}
	...
	public void setReferenceID(String newReferenceID) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CVECatalogPackage.EXTERNAL_REFERENCE__REFERENCE_ID, oldReferenceID, referenceID));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CVECatalogPackage.EXTERNAL_REFERENCE__REFERENCE_ID:
