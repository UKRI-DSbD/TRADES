 ...
 * </p>
 * <ul>
 *   <li>{@link dsm.cve.model.CVECatalog.Weaknesses#getWeaknesses <em>Weaknesses</em>}</li>
 * </ul>
 *
 * @see dsm.cve.model.CVECatalog.CVECatalogPackage#getWeaknesses()
 * @model
 * @generated
 */
public interface Weaknesses extends EObject {
	 ...
	 * The list contents are of type {@link dsm.cve.model.CVECatalog.Weakness}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Weaknesses</em>' containment reference list.
	 * @see dsm.cve.model.CVECatalog.CVECatalogPackage#getWeaknesses_Weaknesses()
