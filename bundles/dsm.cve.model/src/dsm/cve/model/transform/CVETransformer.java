...
import dsm.cve.model.CVECatalog.Category;
...
/**
 * Transformer in charge of importing CVE catalog
 */
public class CVETransformer {
	...
	private void extractVersion(Path path, CVECatalogFactory catalogFactory, WeaknessCatalog weaknessCatalog) {
	...
	private void extractWeaknesses(Path path, CVECatalogFactory catalogFactory, WeaknessCatalog weaknessCatalog) {
	...
	private void extractCategories(Path path, CVECatalogFactory catalogFactory, WeaknessCatalog weaknessCatalog) {
	...
	private void extractViews(Path path, CVECatalogFactory catalogFactory, WeaknessCatalog weaknessCatalog) {
	...
	private void extractExternalReferences(Path path, CVECatalogFactory catalogFactory, WeaknessCatalog weaknessCatalog) {
