...
public class CVEModelActivator extends Plugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "dsm.cve.model"; //$NON-NLS-1$

	// The shared instance
	private static CVEModelActivator plugin;
	 ...
	 */
	public static CVEModelActivator getDefault() {
		return plugin;
	}
	...
	public static void logInfo(String msg) {
		CVEModelActivator act = getDefault();
		if (act != null) {
