...
/**
 * This is the item provider adapter for a {@link dsm.cwe.model.CWECatalog.WeaknessCatalog} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WeaknessCatalogItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CWECatalogPackage.Literals.WEAKNESS_CATALOG__VERSION,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CWECatalogPackage.Literals.WEAKNESS_CATALOG__WEAKNESSES);
			childrenFeatures.add(CWECatalogPackage.Literals.WEAKNESS_CATALOG__CATEGORIES);
			childrenFeatures.add(CWECatalogPackage.Literals.WEAKNESS_CATALOG__VIEWS);
			childrenFeatures.add(CWECatalogPackage.Literals.WEAKNESS_CATALOG__EXTERNAL_REFERENCES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CWECatalogPackage.Literals.WEAKNESS_CATALOG__WEAKNESSES,
				 CWECatalogFactory.eINSTANCE.createWeaknesses()));

		newChildDescriptors.add
			(createChildParameter
				(CWECatalogPackage.Literals.WEAKNESS_CATALOG__CATEGORIES,
				 CWECatalogFactory.eINSTANCE.createCategories()));

		newChildDescriptors.add
			(createChildParameter
				(CWECatalogPackage.Literals.WEAKNESS_CATALOG__VIEWS,
				 CWECatalogFactory.eINSTANCE.createViews()));

		newChildDescriptors.add
			(createChildParameter
				(CWECatalogPackage.Literals.WEAKNESS_CATALOG__EXTERNAL_REFERENCES,
				 CWECatalogFactory.eINSTANCE.createExternalReferences()));
	}
