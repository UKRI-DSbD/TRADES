...
/**
 * This is the item provider adapter for a {@link dsm.TRADES.Category} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CategoryItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addIDPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Category_iD_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Category_iD_feature", "_UI_Category_type"),
						TRADESPackage.Literals.CATEGORY__ID, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Category_name_feature",
								"_UI_Category_type"),
						TRADESPackage.Literals.CATEGORY__NAME, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addStatusPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Category_status_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Category_status_feature",
								"_UI_Category_type"),
						TRADESPackage.Literals.CATEGORY__STATUS, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
