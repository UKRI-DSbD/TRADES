...
/**
 * This is the item provider adapter for a {@link dsm.cve.model.CVECatalog.Category} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CategoryItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CVECatalogPackage.Literals.CATEGORY__ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CVECatalogPackage.Literals.CATEGORY__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addStatusPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Category_status_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Category_status_feature", "_UI_Category_type"),
				 CVECatalogPackage.Literals.CATEGORY__STATUS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Category.class)) {
			case CVECatalogPackage.CATEGORY__ID:
			case CVECatalogPackage.CATEGORY__NAME:
			case CVECatalogPackage.CATEGORY__STATUS:
