...
/**
 * This is the item provider adapter for a {@link dsm.cve.model.CVECatalog.Weakness} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CVECatalogPackage.Literals.WEAKNESS__ID,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 CVECatalogPackage.Literals.WEAKNESS__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addAbstractionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Weakness_abstraction_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Weakness_abstraction_feature", "_UI_Weakness_type"),
				 CVECatalogPackage.Literals.WEAKNESS__ABSTRACTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addStructurePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Weakness_structure_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Weakness_structure_feature", "_UI_Weakness_type"),
				 CVECatalogPackage.Literals.WEAKNESS__STRUCTURE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addStatusPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Weakness_status_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Weakness_status_feature", "_UI_Weakness_type"),
				 CVECatalogPackage.Literals.WEAKNESS__STATUS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
