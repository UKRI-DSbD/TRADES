...
/**
 * This is the item provider adapter for a {@link dsm.cve.model.CVECatalog.Views} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ViewsItemProvider 
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CVECatalogPackage.Literals.VIEWS__VIEWS);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Views.class)) {
			case CVECatalogPackage.VIEWS__VIEWS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CVECatalogPackage.Literals.VIEWS__VIEWS,
				 CVECatalogFactory.eINSTANCE.createView()));
	}
